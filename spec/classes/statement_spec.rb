      ...
      describe 'cql parsing' do
        ...
        context 'when the query is an INSERT query' do
          ...
          it 'should map the key value pairs into the table from the parsed query' do
            ...
            expect(statement.args).to eq(table: 'table', values: {'pk1' => 'hello', 'ck1' => 'world'})
          end
          ...
          context 'with different arguments' do
            it 'should map the key value pairs into the table from the parsed query' do
              ...
              expect(statement.args).to eq(table: 'other_table', values: {'category' => 'goodbye', 'message' => 'cruel world'})
            end
          end
          ...
          context 'with a parameterized query' do
            it 'should apply query parameters to the parsed query' do
              ...
              expect(statement.args).to eq(table: 'table', values: {'category' => 'goodbye', 'message' => 'world', 'sub_message' => 'cruel'})
            end
          end
        end
